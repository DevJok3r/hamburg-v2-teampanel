...
export default function Sidebar({ profile }: SidebarProps) {
  ...
  const isJuniorPlus = ['junior_management', 'management', 'top_management'].includes(profile.role);
  const isManagementPlus = ['management', 'top_management'].includes(profile.role);
  ...
  const navItems = [
    ...
    },
    {
      ...
      show: can.createUser(profile.role),
    },
    {
    ...
    },
{
    ...
    },
    {
      ...
      show: can.viewAdmin(profile.role),
    },
  ];
      ...
      <div className="p-4 border-t border-white/10">
        ...
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-gray-400
                     hover:bg-red-500/10 hover:text-red-400 text-sm transition"
        >
