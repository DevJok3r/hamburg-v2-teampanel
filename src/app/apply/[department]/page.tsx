...
const DEPARTMENTS: Record<string, DeptConfig> = {
  ...
  event: {
    ...
    sections: [
      ...
      },
      {
        title: 'Team-Auswahl',
        fields: [
          { key: 'training_team', label: 'Welches Team möchtest du trainieren?', type: 'select', required: true,
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'situation_5', label: 'Du hast gerade einen Spieler auf Discord verwarnt. Er eröffnet ein Team-Report Ticket und du musst dich äußern. Wie würdest du den Warn als gerechtfertigt argumentieren?', type: 'textarea', required: true, placeholder: 'Deine Argumentation im Report Ticket...' },
        ],
      },
      {
        title: 'Abschluss',
  ...
  development: {
    ...
    color: 'green',
    icon: '💻',
    intro: 'Herzlich willkommen in der Development Team Application für Hamburg V2!\n\nWir freuen uns sehr, dass du Interesse hast, unser Development Team zu unterstützen.\n\nBitte beachte vor dem Ausfüllen:\n• Antworte auf alle Fragen sachlich & ehrlich. Troll- oder Spaßantworten werden ignoriert.\n• Solltest du innerhalb von 7 Tagen keine Rückmeldung von der Fachbereichsleitung Development erhalten, gilt die Bewerbung als abgelehnt.\n• Stelle sicher, dass deine Discord-DMs öffentlich sind, damit wir dich kontaktieren können.\n• Nur angenommene Bewerber werden zu einem Bewerbungsgespräch eingeladen.\n\nWir wünschen dir viel Erfolg bei deiner Bewerbung! 🚀',
    sections: [
      {
        title: 'Persönliche Informationen',
        fields: [
      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'dev_experience', label: 'Hast du bereits Erfahrungen im Development? Falls ja, welche Erfahrung hast du gemacht?', type: 'textarea', required: true, placeholder: 'Beschreibe deine Erfahrungen ausführlich...' },
      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'disagreement',     label: 'Stell dir vor, ein Teammitglied hat eine andere Lösungsidee als du – wie würdest du reagieren?', type: 'textarea', required: true, placeholder: 'Deine Reaktion bei unterschiedlichen Meinungen...' },
        ],
      },
      {
        title: 'Abschluss',
...
function formToDb(department: string, values: Record<string, string>) {
  ...
  // Alle Fragen als JSON in extra_q1/q2/q3 packen – wir speichern alles als JSON blob
